...
const componentProps = [
	...
	{
		default: `YYYY-MM-DD`,
		desc: 'Sets the format for the <code class="ic">VTextField</code> input and the <code class="ic">VDatePicker</code> component. Ex. <code class="ic">YYYY-MM-DD</code>, <code class="ic">MM-DD-YYYY</code>, <code class="ic">DD-MM-YYYY</code>',
		name: 'format',
