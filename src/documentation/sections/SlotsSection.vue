<template>
	<v-row>
		...
		>
			...
			The default slot used for the <code class="ic">VDateField</code> icon is the <code class="ic">prepend-inner</code>
			slot. The <code class="ic">VDateField</code> and <code class="ic">VTextField</code> slots are available. For info on
			the specific slots, please refer to the <a
			...
			>prepend-inner</code>, <code class="ic">append-inner</code>, and <code class="ic">append</code> slots called <code
				class="ic"
			>toggleDatePicker</code> that can be used to toggle the color picker.
		</v-col>
